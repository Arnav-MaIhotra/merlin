...
stocks_df = pd.read_csv(stocks_csv_path)[1750:3500]
...
pd.DataFrame.from_dict({"Ticker":tuple(diffs.keys()), "Undervalue Score":tuple(diffs.values())}).to_csv("undervalue_score_2.csv", index=False)