...
df = pd.DataFrame({"Ticker":tickers, "Growth":growths, "Date":dates, "Altman Z-Score":z_scores})

df.to_csv(r"C:\Users\arnav\OneDrive\Documents\Merlin\Neural Network\altman_only\altman_metrics_buys.csv", index=False)

print("Starting process #2")

#time.sleep(60)

import altman_at_sells