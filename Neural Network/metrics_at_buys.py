...
shifts = pd.read_csv(r"C:\Users\arnav\OneDrive\Documents\Merlin\Neural Network\v1\buy_metrics_v1.csv")
...
df.to_csv(r"C:\Users\arnav\OneDrive\Documents\Merlin\Neural Network\v2\buy_metrics_v2.csv", index=False)

print("Starting process #2")

#time.sleep(60)

import metrics_at_sells